...
public class TestOOP4 {
    public static void main(String[] args) {
        ...
        Mechanic<Car> anton = new Mechanic<>("Антон Рублев", "Автозапчасти");
        ...
        Sponsor bashneft = new Sponsor("Башнефть", 35_350.50);
        ...
        DriverB boris = new DriverB("Borisov Boris Borisovich", true, 5, lada);
